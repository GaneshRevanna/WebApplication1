                  ...
                  <div class="row">
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False"  OnRowDataBound="GridView1_RowDataBound" >
                         ...
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDBConnectionString8 %>" ProviderName="<%$ ConnectionStrings:elibraryDBConnectionString8.ProviderName %>" SelectCommand="SELECT [member_name], [member_id], [book_id], [book_name], [issue_date], [due_date] FROM [book_issue_tbl]"></asp:SqlDataSource>
                     </div>
                  </div>
               </div>
            </div>
